 ...
 */
export default function ShareCardButton({ data, template, alamat, slug }: Props) {
  ...
  return (
    <>
      <button
        onClick={buat}
        disabled={sibuk}
        className="flex items-center gap-1.5 bg-white/15 hover:bg-white/25 disabled:opacity-60 text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-all backdrop-blur-sm"
      >
